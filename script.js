...
let age = ageInput === null ? NaN : parseInt(ageInput.trim(), 10);
...
console.log(a);
console.log(typeof b); // I wrote console.log(b); and it said this "Uncaught ReferenceError: b is not defined"
